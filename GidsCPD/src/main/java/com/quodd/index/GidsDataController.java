...
public class GidsDataController {
	...
	public static final Route getTickerServices = (Request request, Response response) -> {
		...
		if (datacache.getServiceCodeGids() == id || datacache.getSnapServiceCodeGids() == id)
			return datacache.getGidsTickerMap().keySet();
