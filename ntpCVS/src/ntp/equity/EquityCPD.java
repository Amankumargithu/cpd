...
public class EquityCPD {
	...
	public static void main(String[] args) {
		...
		if(isSubTypeTicker)
		{
			...
			EquitySubscriptionManager equitySubscriptionManager = new EquitySubscriptionManager(1, isNasdaqbasic);
			equitySubscriptionManager.subscribeTickers(Arrays.asList(insts));
		}
		else
		{
			NTPLogger.info("Equity CPD is running in Exchange mode");
			...
			if(snapIP != null)
			{
				...
				NTPLogger.missingProperty("SUBSCRIBE_IP");
			EquitySubscriptionManager equitySubscriptionManager = new EquitySubscriptionManager(numberofChannels + 1, isNasdaqbasic);			
