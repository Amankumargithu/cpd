...
public class ScrollingPopupQuoteNewsAction extends B4UTradeDefaultAction {

   static Log log = LogFactory.getLog(ScrollingPopupQuoteNewsAction.class);
   ...
   throws IOException, ServletException {
      ...
      //homeForm.reset(mapping, request);
