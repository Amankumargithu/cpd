...
public class BlackScholesCalculator {
    ...
    public String getGamma() {
    	String gammaValue=String.valueOf(gamma);
    	if(gammaValue.equalsIgnoreCase("NaN"))
    		gammaValue="";
	   return gammaValue;
    }
    ...
    public static void main(String[] args) {
       ...
       if (args.length != 7) {
          System.out.println("USAGE: java BlackScholesCalculator stockPrice " +
                                                                "strikePrice " +
                                                                "timeToExpiration "+
       ...
       BlackScholesCalculator bsc = new BlackScholesCalculator(Double.parseDouble(args[0]),
       ...
       System.out.println("Option Price: "+bsc.optionPrice);
       System.out.println("delta: "+bsc.delta);
       System.out.println("gamma: "+bsc.gamma);
       System.out.println("theta: "+bsc.theta);

       double iv = BlackScholesCalculator.impliedVolatilityNewtonSteps(bsc.stockPrice,
                                                                       bsc.strikePrice,
                                                                       bsc.timeToExpiration,
                                                                       bsc.rate,
                                                                       bsc.volatility,
                                                                       Double.parseDouble(args[6]),
                                                                       bsc.putFlag);

       System.out.println("implied volatility (newton steps): "+iv);

       iv = BlackScholesCalculator.impliedVolatilityBisections(bsc.stockPrice,
                                                               bsc.strikePrice,
                                                               bsc.timeToExpiration,
                                                               bsc.rate,
                                                               bsc.volatility,
       ...
       System.out.println("implied volatility (bisections): "+iv);
    }
