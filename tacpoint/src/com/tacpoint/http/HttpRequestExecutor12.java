/**
 * HttpRequestExecutor12 -  Administers the client's http/https request.
 *
 ...
 */
public class HttpRequestExecutor12 {
     ...
     */
     public void execute(HttpConfiguration c) throws BusinessException {
       ...
       try {
          ...
          e.printStackTrace();
          throw new BusinessException("HttpRequestExecutor12.execute - "+
