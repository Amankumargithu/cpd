...
import static com.quodd.cpd.AlertCpd.hashTypeToken;
...
public class UserAlertDetailBean implements Serializable {
...
//	private static final boolean ACTIVITY_CHECKED = true;
	...
	public void addAlertFromJson(String json) throws QuoddException {
		try {
			HashMap<String, Object> bean = gson.fromJson(json, hashTypeToken);
			Map<String, Object> lookup = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
			lookup.putAll(bean);
			this.alertName = (String) lookup.get("alertName");
			this.tickerName = (String) lookup.get("tickerName");
			this.webFlag = (String) lookup.get("webFlag");
			this.alertComments = (String) lookup.get("alertComments");
			this.alarmTime = (String) lookup.get("alarmTime");
			Double id = (Double) lookup.get("alertFrequency");
			this.alertFrequency = id == null ? ALERT_DELETE_AFTER_FIRST_ALERT : id.intValue();
			this.lastOverAlertValue = (String) lookup.get("lastOverAlertValue");
			this.lastUnderAlertValue = (String) lookup.get("lastUnderAlertValue");
			this.lastEqualAlertValue = (String) lookup.get("lastEqualAlertValue");
			this.percentChangeUpAlertValue = (String) lookup.get("percentChangeUpAlertValue");
			this.percentChangeDownAlertValue = (String) lookup.get("percentChangeDownAlertValue");
			this.bidOverAlertValue = (String) lookup.get("bidOverAlertValue");
			this.bidUnderAlertValue = (String) lookup.get("bidUnderAlertValue");
			this.bidEqualAlertValue = (String) lookup.get("bidEqualAlertValue");
			this.lastTradeVolumeOverAlertValue = (String) lookup.get("lastTradeVolumeOverAlertValue");
			this.lastTradeVolumeEqualAlertValue = (String) lookup.get("lastTradeVolumeEqualAlertValue");
			this.lastTradeVolumeEqualOverAlertValue = (String) lookup.get("lastTradeVolumeEqualOverAlertValue");
			this.askOverAlertValue = (String) lookup.get("askOverAlertValue");
			this.askUnderAlertValue = (String) lookup.get("askUnderAlertValue");
			this.askEqualAlertValue = (String) lookup.get("askEqualAlertValue");
			this.volumeOverAlertValue = (String) lookup.get("volumeOverAlertValue");
			this.volumeUnderAlertValue = (String) lookup.get("volumeUnderAlertValue");
			this.volumeEqualAlertValue = (String) lookup.get("volumeEqualAlertValue");

			this.lastOverAlertActivity = (Boolean) lookup.get("lastOverAlertActivity");
			this.lastOverAlertActivity = (Boolean) lookup.get("lastOverAlertActivity");
			this.lastUnderAlertActivity = (Boolean) lookup.get("lastUnderAlertActivity");
			this.lastEqualAlertActivity = (Boolean) lookup.get("lastEqualAlertActivity");
			this.percentChangeUpAlertActivity = (Boolean) lookup.get("percentChangeUpAlertActivity");
			this.percentChangeDownAlertActivity = (Boolean) lookup.get("percentChangeDownAlertActivity");
			this.bidOverAlertActivity = (Boolean) lookup.get("bidOverAlertActivity");
			this.bidUnderAlertActivity = (Boolean) lookup.get("bidUnderAlertActivity");
			this.lastTradeVolumeEqualAlertActivity = (Boolean) lookup.get("lastTradeVolumeEqualAlertActivity");
			this.lastTradeVolumeOverAlertActivity = (Boolean) lookup.get("lastTradeVolumeOverAlertActivity");
			this.lastTradeVolumeEqualOverAlertActivity = (Boolean) lookup.get("lastTradeVolumeEqualOverAlertActivity");
			this.bidEqualAlertActivity = (Boolean) lookup.get("bidEqualAlertActivity");
			this.askOverAlertActivity = (Boolean) lookup.get("askOverAlertActivity");
			this.askUnderAlertActivity = (Boolean) lookup.get("askUnderAlertActivity");
			this.askEqualAlertActivity = (Boolean) lookup.get("askEqualAlertActivity");
			this.volumeOverAlertActivity = (Boolean) lookup.get("volumeOverAlertActivity");
			this.volumeEqualAlertActivity = (Boolean) lookup.get("volumeEqualAlertActivity");
			this.volumeUnderAlertActivity = (Boolean) lookup.get("volumeUnderAlertActivity");
			this.fiftyTwoWeekHighAlertActivity = (Boolean) lookup.get("fiftyTwoWeekHighAlertActivity");
			this.fiftyTwoWeekLowAlertActivity = (Boolean) lookup.get("fiftyTwoWeekLowAlertActivity");
			this.companyNewsAlertActivity = (Boolean) lookup.get("companyNewsAlertActivity");
			this.earningsReportedAlertActivity = (Boolean) lookup.get("earningsReportedAlertActivity");
		} catch (ClassCastException e) {
			throw new QuoddException(Constants.ERROR_JSON_TYPE_MISMATCH);
		} catch (Exception | Error e) {
			throw new QuoddException(Constants.ERROR_PARSE_JSON);
		}
	}
}
